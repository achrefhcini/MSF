...
public class Mail 
{
	...
	public static void generateAndSendEmail(String to) throws AddressException, MessagingException {
		...
		transport.connect("smtp.gmail.com", "wassim9994@gmail.com", "wassimL23262954");
